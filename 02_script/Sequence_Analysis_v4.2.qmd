...
#Exibindo as frequências relativas dos grupos
seqdplot(mvad.seq, with.legend = "right", border = NA, main = "Distribução de estados - Pós-pandemia")
```
...
#Exibindo todas as sequências do dataframe (gráfico de índices)
seqIplot(mvad.seq, sortv = "from.start", with.legend = "right", main = "Gráfico de Índices - Pós-pandemia")
```
