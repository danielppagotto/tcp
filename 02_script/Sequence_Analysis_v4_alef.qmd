...
actcal.seq <- seqdef(data_pre_pandemia_wide, var = 2:6)
...
Abaixo, será definido o número de clustering. E por fim, será gerado um gráfico de índices para cada clustering definido.
