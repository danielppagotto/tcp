...
Observa-se que muitos valores "null" e missings foram gerados. A quantidade de indivíduos que apresentaram pelo menos um valor ausente durante as entrevistas totalizaram o valor de 52.718, que no código abaixo serão filtrados. Os valores "null" referem-se a indivíduos que não completaram as 5 entrevistas entre 2018 e 2019, ou aqueles que deixaram de responder alguma das sessões (esses valores totalizaram 83.658 indivíduos).

E por fim, removeremos os indivíduos que não atuaram como conta própria em nenhuma das entrevistas (total de 2.142 remoções). Restando uma uma base para a análise de sequências de 37.376 indivíduos.
...
actcal.seq <- seqdef(data_pre_pandemia_wide, var = 3:7)
...
data_pre_pandemia_wide$cluster <- part
...
png("seu_grafico2.png", width = 800, height = 600)
...
png("seu_grafico3.png", width = 800, height = 600)
...
Observa-se que muitos valores "null" e missings foram gerados. A quantidade de indivíduos que apresentaram pelo menos um valor ausente durante as entrevistas totalizaram o valor de 26.975, que no código abaixo serão filtrados. Os valores "null" referem-se a indivíduos que não completaram as 5 entrevistas entre 2020 e 2021, ou aqueles que deixaram de responder alguma das sessões (esses valores totalizaram 65.011 indivíduos).

E por fim, removeremos os indivíduos que não atuaram como conta própria em nenhuma das entrevistas (total de 627 remoções). Restando uma uma base para a análise de sequências de 15.384 indivíduos.
...
data_pandemia_wide$cluster <- part
...
Observa-se que muitos valores "null" e missings foram gerados. A quantidade de indivíduos que apresentaram pelo menos um valor ausente durante as entrevistas totalizaram o valor de 33.144, que no código abaixo serão filtrados. Os valores "null" referem-se a indivíduos que não completaram as 5 entrevistas entre 2022 e 2023, ou aqueles que deixaram de responder alguma das sessões (esses valores totalizaram 31.168 indivíduos).

E por fim, removeremos os indivíduos que não atuaram como conta própria em nenhuma das entrevistas (total de 1.580 remoções). Restando uma uma base para a análise de sequências de 29.580 indivíduos.
...
data_pos_pandemia_wide$cluster <- part
