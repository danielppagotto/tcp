...
svyttest(V1022 ~ cluster, sub_design)
```
...
sub_design$variables$chefe_domicilio <- ifelse(sub_design$variables$ensino_superior == "Superior completo", 1, 0)

svyttest(chefe_domicilio ~ cluster, sub_design)
...
descritivo_atividade_long %>%
  ...
  theme(axis.text.y = element_text(size = 9),   # após coord_flip os rótulos ficam em axis.text.y
        legend.position = "top")
```
