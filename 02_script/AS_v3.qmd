...
chefe_familia <- svyby(~Persistente + Precarizado + Transitório, ~chefe_domicilio, design, svymean) |> 
  mutate(total = Persistente + Precarizado + Transitório,
         perc_Persistente = Persistente / total,
         perc_Precarizado = Precarizado / total,
         perc_Transitório = Transitório / total) |> 
...
```{r}
genero <- svyby(~Persistente + Precarizado + Transitório, ~V2007, design, svymean) |> 
  mutate(total = Persistente + Precarizado + Transitório,
         perc_Persistente = Persistente / total,
         perc_Precarizado = Precarizado / total,
         perc_Transitório = Transitório / total) |> 
...
```{r}
escolaridade <- svyby(~Persistente + Precarizado + Transitório, ~VD3004, design, svymean) |> 
  mutate(total = Persistente + Precarizado + Transitório,
         perc_Persistente = Persistente / total,
         perc_Precarizado = Precarizado / total,
         perc_Transitório = Transitório / total) |> 
