...
design <- svydesign(ids = ~1, weights = ~V1028, data = data_teste)

proporcoes <- svyby(~Persistente + Precarizado + Transitório, ~UF, design, svymean)

# Renomear e reestruturar
