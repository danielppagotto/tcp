...
data_1 <- read_excel("C:/Users/alefs/OneDrive/Documentos/LAPEI-CIGETS/GitHub/tcp/02_script/dados_22_23_tratados.xlsx")
...
Geraremos três amostras aleatórios de 5000 observações para testar os diferentes métodos de clusterização. A primeira amostra será usada para "treinar" e a segunda e terceira amostras serão aplicadas para "testar".
...
relacao_cluster |> 
  ...
  mutate(idade_media = round(idade_media, 2))
...
escolaridade <- 
  ...
  mutate(escolaridade = case_when(
                            VD3004 == 'Fundamental completo ou equivalente' | VD3004 == 'Fundamental incompleto ou equivalente' ~ 'Até fundamental completo', 
                            VD3004 == 'Médio completo ou equivalente' | VD3004 == 'Médio incompleto ou equivalente' ~ 'Até médio completo', 
                            VD3004 == 'Sem instrução e menos de 1 ano de estudo' ~ 'Sem instrução', 
                            VD3004 == 'Superior completo' | VD3004 == 'Superior incompleto ou equivalente' ~ 'Até superior completo' 
  )) |> 
  group_by(relacao_cluster, escolaridade) |> 
...
relacao_cluster_18_19 |> 
  ...
  mutate(relacao_cluster_18_19 = case_when(
                              ...
                              relacao_cluster_18_19 == '3' ~ 'Precarizado'
  )) |> 
